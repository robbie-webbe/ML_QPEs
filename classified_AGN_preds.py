...
#load the Tranin et al classified types catalogue
type_cat = fits.open(os.getcwd()+'/classification_DR12_with_input.fits')

#pick out the srcids for the AGN sample in the classified catalogue
