    ...
    if cat[1].data.field('CCDPN')[i] != -32768 :
        ...
        if os.path.getsize(os.getcwd()+'/_dl_temp_/source_pnlc.tar') != 0:
            ...
            for file in os.listdir('_dl_temp_/'+obsid+'/pps/'):
                ...
                rate = hdul[1].data.field('RATE1') + hdul[1].data.field('RATE2') + hdul[1].data.field('RATE3')
                ...
                feats_50 = [lcfeat([lc_50.time,lc_50.countrate],qpe='?')[4]]
                feats_250 = lcfeat([lc_250.time,lc_250.countrate],qpe='?')[np.array([1,3,7,8,9,10])]
                feats_1000 = lcfeat([lc_1000.time,lc_1000.countrate],qpe='?')[np.array([1,3,4,6,7,8,9,10])]
                ...
                if pred_50[1] > 0.9 and pred_250[1] > 0.9 and pred_1000[1] > 0.9:
                    ...
                    if pred_50[1] == 1.0 and pred_250[1] == 1.0 and pred_1000[1] == 1.0:
                        fig.savefig('4XMMSSC/red_feats/conf_1/'+outfile_name)
                    elif pred_50[1] > 0.99 and pred_250[1] > 0.99 and pred_1000[1] > 0.99:
                        fig.savefig('4XMMSSC/red_feats/conf_99/'+outfile_name)
                    else:
                        fig.savefig('4XMMSSC/red_feats/conf_90/'+outfile_name)
                    plt.close()
...
predictions_dt50.to_csv('4XMMSSC/red_feats/predictions_pndt50.csv')
predictions_dt250.to_csv('4XMMSSC/red_feats/predictions_pndt250.csv')
predictions_dt1000.to_csv('4XMMSSC/red_feats/predictions_pndt1000.csv')
top_candidates.to_csv('4XMMSSC/red_feats/top_QPE_cands_pn.csv')
...
features_dt50.to_csv('4XMMSSC/red_feats/features_pndt50.csv')
features_dt250.to_csv('4XMMSSC/red_feats/features_pndt250.csv')
features_dt1000.to_csv('4XMMSSC/red_feats/features_pndt1000.csv')
